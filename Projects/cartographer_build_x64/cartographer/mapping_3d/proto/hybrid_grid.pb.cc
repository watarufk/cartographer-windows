...
namespace proto {
class HybridGridDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<HybridGrid> {
...
void TableStruct::Shutdown() {
  _HybridGrid_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _HybridGrid_default_instance_.DefaultConstruct();
}
